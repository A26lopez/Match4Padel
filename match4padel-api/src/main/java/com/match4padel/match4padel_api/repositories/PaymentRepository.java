...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    """)
    List<Payment> findNonCancelledPaymentsByReservation(@Param("reservation") Reservation reservation);
    ...
    """)
    List<Payment> findPendingCashPaymentsOfFinishedReservations(@Param("today") LocalDate today, @Param("now") LocalTime now);
}
